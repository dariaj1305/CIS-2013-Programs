...
var passwordCheckOld = function ()
{
    ...
    // This is a list of all of the "bad" passwords
    ...
    stringOutput = "";
    // Checks to see if password is in the BadPassword list and has at least 8 characters
    if(stringPassword.length < 8)
    {
        stringOutput = "Your password must be at least 8 characters long.";
    }
  else
{
  // Checks the password considering the above list of bad ones
  // If the password is in the list, it will send an alert that it's too weak
...
for (var a=0; a<arrayBadPasswords.length; a++)
   {
    ...
    {
        stringOutput = "This password is too weak. Please try again";
        break;
    }
   }
}

//If the password is not in the list and works, it will send an alert that it works
if (stringOutput != "")
{
